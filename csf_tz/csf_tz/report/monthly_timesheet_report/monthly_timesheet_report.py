...
def execute(filters=None):
	...
	if filters.hours_per_day:
		...
		if not records:
			frappe.throw(
				"No Record found for the filters From Date: {0}, To Date: {1}, Hours Per Day: {2} you specified..., \
		...
		if not project_details:
			frappe.throw(
				"No Record found for the filters From Date: {0}, To Date: {1} and Hours Per Project: {2} you specified..., \
			Please change your filters and try again..!!".format(
					frappe.bold(filters.from_date),
					frappe.bold(filters.to_date),
		...
		if not timesheet_rows:
			frappe.throw(
				"No Record found for the filters From Date: {0}, To Date: {1} you specified..., \
			Please change your filters and try again..!!".format(
					frappe.bold(filters.from_date),
					frappe.bold(filters.to_date),
				)
